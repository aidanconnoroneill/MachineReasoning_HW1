...
Our results were largely in line with those of Russell and Norvig.  As we can see 
from Figure 1, \text{h_2} hugely outperforms \text{h_1}, especially as the size
